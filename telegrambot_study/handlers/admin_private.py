...
from telegrambot_study.database.orm_query import (
...
from telegrambot_study.filters.chat_types import ChatTypeFilter, IsAdmin

from telegrambot_study.kbds.inline import get_callback_btns
from telegrambot_study.kbds.reply import get_keyboard
...
async def back_step_handler(message: types.Message, state: FSMContext) -> None:
    ...
    if current_state == AddProduct.name:
        await message.answer(
            'Пред идущего шага нет, или введите название товара или напишите "отмена"'
        )
        return
...
# Хендлер для отлова неправильного ввода для состояния price
